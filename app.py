...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team':[batting_team],'bowling_team':[bowling_team],'city':[city],'runs_left':[runs_left],'balls_left':[balls_left],'wickets':[wicket],'total_runs_x':[target],'crr':[crr],'rrr':[rrr]})
